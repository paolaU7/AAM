...
## 👤 Persona 2 — Profesores + Bugs (7 tareas)
...
## 👤 Persona 3 — Materias + Alumnos (8 tareas)
...
5. **Identificador corto de materia (requiere schema nuevo).** Agregar
   ...
   manual por si el auto-generado queda ambiguo entre dos materias.
...
## 👤 Persona 4 — Asistencia + Usuarios + Reportes + Configuración (14 tareas)
