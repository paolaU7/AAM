...
class SchoolSettingsModel(Base):
    ...
    división que se ofrecen en los desplegables de alta de curso). Editable
    a futuro desde Configuración. `id` es BOOLEAN con CHECK(id) para forzar
    una sola fila posible en la tabla."""
